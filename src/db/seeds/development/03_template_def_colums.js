...
exports.seed = async knex => {
  ...
  await knex('dev.template_defs').insert([
    { id: 1, template_name: 'olr_listing_file', published: true, valid: true},
    { id: 2, template_name: 'olr_building_file', published: true, valid: true}
  ]);
  ...
  await knex('dev.template_columns').insert([
    ...
    { id: 4, template_id: 2, dest_column_id: 4, mapping_type: 'column', mapping_value: 'streetAddr' },
    { id: 5, template_id: 2, dest_column_id: 5, mapping_type: 'column', mapping_value: 'zipCode' },
    { id: 6, template_id: 2, dest_column_id: 6, mapping_type: 'column', mapping_value: 'desc' },
  ]);
};
